table 72097 "Posted Daily Attendance"
{
    ...
    fields
    {
        ...
        field(56; "Present (Yes/No)"; Boolean)
        {
        ...
        field(57; "Absent (Yes/No)"; Boolean)
        {
            Caption = 'Absent (Yes/No)';
        ...
        field(58; "Leave (Yes/No)"; Boolean)
        {
            Caption = 'Leave (Yes/No)';
        ...
        field(59; "Weekly Off (Yes/No)"; Boolean)
        {
            Caption = 'Weekly Off (Yes/No)';
        ...
        field(60; "Holiday (Yes/No)"; Boolean)
        {
            Caption = 'Holiday (Yes/No)';
        ...
        field(61; "On-Duty (Yes/No)"; Boolean)
        {
            Caption = 'On-Duty (Yes/No)';
        ...
        field(62; "Not Joined (Yes/No)"; Boolean)
        {
            Caption = 'Not Joined (Yes/No)';
        ...
        field(63; "Relieved (Yes/No)"; Boolean)
        {
            Caption = 'Relieved (Yes/No)';
