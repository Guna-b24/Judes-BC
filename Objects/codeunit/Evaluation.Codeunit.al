codeunit 71001 Evaluation
{
    ...
    [Scope('Internal')]
    procedure GetApplicants(var EvaluationNo: Code[10])
    var
    ...
    [Scope('Internal')]
    procedure "Selection Process"(var "SelectionNo.": Code[10]): Decimal
    var
    ...
    [Scope('Internal')]
    procedure CalcTotal(var "ApplicationNo.": Code[10]): Decimal
    begin
        // Start 03.GUNA
        Clear(Total);
        ApplicantEvaluation.Reset;
    ...
    [Scope('Internal')]
    procedure CalcRank(var SelectionProcessLine: Record "Selection Process Line")
    var
    ...
    [Scope('Internal')]
    procedure "Prequalification Marks"(var ApplicantEvaluation: Record "Applicant Evaluation")
    var
